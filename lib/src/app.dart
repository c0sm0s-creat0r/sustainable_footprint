...
import 'package:sustainable_footprint/src/screens/results_view.dart';
import 'screens/quiz_view.dart';
import 'screens/nav_list_view.dart';
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  ...
                  case QuestionView.routeName:
                    ...
                    return QuestionView(
                        count: (routeSettings.arguments != null)
                            ? routeSettings.arguments as int
                            : -99);
                  case ResultsView.routeName:
                    return const ResultsView();
                  case FootprintView.routeName:
                    return const FootprintView();
                  case HoldingView.routeName:
                    return const HoldingView();
                  case NavListView.routeName:
                  default:
                    SystemChrome.setPreferredOrientations([
                      DeviceOrientation.portraitUp,
                    ]);
                    return const NavListView();
                }
              },
            );
          },
